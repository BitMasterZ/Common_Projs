...
Begin VB.Form frmLvl6 
   ...
   ClientWidth     =   18195
   ControlBox      =   0   'False
   Icon            =   "frmLvl6.frx":0000
   LinkTopic       =   "Form1"
   Picture         =   "frmLvl6.frx":0ECA
   ScaleHeight     =   676
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   1213
