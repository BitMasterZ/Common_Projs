...
rod.Top = ufo.Top
If Form2.blueleft.Value = Checked Then
n = -n
p = -p
u = -u
ElseIf Form2.redright.Value = Checked Then
n = -n
p = -p
u = -u
ball.Visible = False
...
End If
End If
If Form2.redright.Value = Checked Then
...
End If
End If
If Form2.blueright.Value = Checked Then
If Timer1.Enabled = True Then
Timer1.Enabled = False
pause.Caption = "PLAY"
ElseIf Timer1.Enabled = False Then
...
ElseIf Form2.blueright.Value = Checked Then
wall.Top = 2640
wall.Left = 120
wall.Height = 2655
wall.Width = 135
...
ElseIf ticktock.Caption = 30 Then
redwin.Visible = True
redwin.Caption = "Draw"
